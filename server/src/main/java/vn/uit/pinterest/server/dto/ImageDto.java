...
public class ImageDto {
    ...
    public ImageDto(String imgId, List<Comment> comments) {
        this.imgId = imgId;
    ...
    public ImageDto imgId(String imgId) {
        setImgId(imgId);
        return this;
    }

    public ImageDto comments(List<Comment> comments) {
